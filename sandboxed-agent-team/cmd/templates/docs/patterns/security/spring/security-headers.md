...
If a strict CSP beyond Vaadin's default relaxations is required, do **not** use
Spring Security's `headers().contentSecurityPolicy(...)` — use Vaadin's
[nonce-based strict CSP](https://vaadin.com/docs/latest/flow/security/advanced-topics/strict-csp)
